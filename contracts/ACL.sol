...
contract ACL {
    ...
    constructor (address _fileIntegrityCon, address _identityCon) {
    ...
    mapping(address => mapping(string => Acl)) private allACLs;
    ...
    function createACL(address _user, address _csp, string memory _id, bool _isPublic, string memory _s1, string memory _s2) public {
        ...
        require(fileIntegrityCon.verifyDataOwner(_user, _id) == true);
        Acl storage newACL = allACLs[_csp][_id];
        newACL.id = _id;
